...
class Usuario extends Eloquent {
  ...
  public function es_desarrollador() {
    return $this->id == 1;
  }
  ...
  public static function saveImage($udata, $user) {
    ...
    imagedestroy($image);
    static::createResizedImages($user);
  }

  private static function createResizedImages($id) {
    Image::make(public_path() . ("/avatares/userimages/{$id}.png"))->resize(20, 20)->save(public_path() . ("/avatares/userimages/thumbnail/{$id}.png"));
    Image::make(public_path() . ("/avatares/userimages/{$id}.png"))->resize(64, 64)->save(public_path() . ("/avatares/userimages/small/{$id}.png"));
  }
