...
<h3><i class='icon icon-asterisk'></i> Cursos creados</h3>
...
{/if}
<h6 style="margin-top: -20px;" class="pull-right"><i class='icon icon-plus'></i> <a href='#nuevo-curso' data-toggle='modal'>Crear nuevo curso</a></h6>
