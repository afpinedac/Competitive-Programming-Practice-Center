...
<html lang="es">
  <head>
    ...
    <meta name="description" content="CPP es un sitio excelente 2 para los profesores e Instituciones Educativas que desean contar con una plataforma Virtual de Aprendizaje para la enseñanza y práctica de la Programación Competitiva"/>
