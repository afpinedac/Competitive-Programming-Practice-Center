<div class="row-fluid">
  <div class="span12">
    ...
    <div class="row-fluid">
      <div class="span12">        
        <a style="margin-bottom: -30px" href='{url('curso/ver')}/{$curso->id}/mis-envios' title="Información de todos los envios" class="pull-left"> <i class='icon icon-cogs'></i> Ver todos mis envíos</a>
        <h3  id="ejercicios" class="pull-right"><i class='icon icon-cogs icon-2x'></i> Ejercicios </h3>&nbsp;
      </div>
    </div>
  </div>
</div>
